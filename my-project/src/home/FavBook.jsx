...
import FavBookImg from "../assets/assets/favoritebook.jpg";
  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
          ...
          <p className='text-lg md:w-5/6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore recusandae quos iusto dolore unde adipisci maxime enim animi iure tempore nulla repellat corrupti vitae quod expedita soluta voluptatem, illum nisi!</p>
        {/*stats*/}
